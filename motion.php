  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">MOTION</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Motion</a></li>
              ...
              <div class="col-12">
                ...
                <div class="card card-primary card-outline">
                  <div class="card-header">
                    <h3 class="card-title"><i class="far fa-chart-bar"></i> Room 1 - Motion Detection History</h3>
...
<script>
  $(function () {
    ...
    $.ajax({
      url: 'get-data-motion.php',
      method: 'GET',
      dataType: 'json',
      success: function (response) {
        var data = response.map(function (item) {
          // Ensure the value is either 0 or 1
          var value = (item[1] == 1) ? 1 : 0; // Convert value to 1 or 0 if necessary
          return [item[0], value];
        });
        ...
        $('#line-chart').bind('plothover', function (event, pos, item) {
          if (item) {
            ...
            $('#line-chart-tooltip').html('Time: ' + x)
              .css({
                top: item.pageY + 5,
                left: item.pageX + 5
              })
